...
VALGRIND = valgrind --tool=memcheck --verbose --leak-check=full --log-file=valgrind.log ./$(TARGET) outputs/compressed/gophers.hbt
...
test1: $(TARGET)
	./$(TARGET) outputs/compressed/gophers.hbt
	diff gophers.dec examples/original/gophers
